...
export const assistantManagementEnabled = import.meta.env.MODE === 'assistant' || import.meta.env.MODE === 'production';
export const assistantEnabled = assistantManagementEnabled || import.meta.env.MODE === 'api-static';
